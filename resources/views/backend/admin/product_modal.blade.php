	...
	<div class="modal-lg modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h2 class="modal-title" id="ModalTitle"><strong>Hóa đơn nhập</strong></h2>
			</div>
				...
				<div class="modal-body">
					<table id="in-receipts-form-table" class="table  table-striped table-bordered table-hover table-responsive ">
						<thead>
							<tr>
								<th>Stt</th>
								<th>Tên sản phẩm <button type="button" class="more" data-toggle="modal" data-target="#productModal" data-name="Thêm sản phẩm" title="Thêm sản phẩm"><i class="fa fa-plus-square-o more"></i></button></th>
								...
								<th>Giá đơn vị</th>
								<th>Thành tiền</th>
								<th><a href="javascript:;" class="add btn btn-primary btn-sm add-row" data-target="1" title="Thêm dòng"><i class="fa  fa-plus"></i></a></th>
							</tr>
						</thead>
						<tbody>
							<tr>
