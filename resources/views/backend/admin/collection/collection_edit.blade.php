 ...
 @section('title')
 <title>NH Store | Update collection</title>
 @endsection
 @section('css')
 	...
 	<section class="content">
 		...
 		<div class="box">
 			<div class="box-header with-border">
 				<h3 class="box-title">Chỉnh sửa bộ sưu tập</h3>
 			</div>
 			<div class="box-body">
 				<form action="javascript:;" id="collectionsForm">
 					<div class="form-group">
 						<label for="name"	>Tên bộ sưu tập</label>
 						<input class="form-control" value="{{$collection->name}}" placeholder="Nhập tên bộ sưu tập" type="text" id="name" name="name">
 					...
 					<div class="form-group">
 						...
 						<option value="{{$product->id}}" selected data-image="{{$product->images->where('is_thumbnail',1)->first()['75X75']}}">{{$product->name}}</option>
 						@else
 				...
 				<div class="form-group">
 					...
 					<img class="form-control" data-input="1920X1056" data-preview="1920X1056-preview" style="height: 50%" src="{{$collection['1920x1056']}}" id="1920X1056-preview">
 					<input id="1920X1056" class="form-control input-img" type="text" name="1920X1056" readonly >
 				</div>
 				<div class="form-group">
 					<img style="height: 50%; width:33%;" data-input="450X362" data-preview="450X362-preview" src="{{$collection['450x362']}}" id="450X362-preview">
 					<input id="450X362" class="form-control input-img" type="text" name="450X362" readonly >
 					<img style="height: 50%; width:33%;" data-input="540X494" data-preview="540X494-preview" src="{{$collection['540x494']}}" id="540X494-preview">
 					<input id="540X494" class="form-control input-img" type="text" name="540X494" readonly >
 					<img style="height: 50%; width:33%;" data-input="540X340" data-preview="540X340-preview" src="{{$collection['540x340']}}" id="540X340-preview">
