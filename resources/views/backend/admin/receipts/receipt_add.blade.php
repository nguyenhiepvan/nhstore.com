 ...
 @section('title')
 <title>NH Store | Add new in receipt</title>
 @endsection
 @section('css')
 ...
 <script type="text/javascript" src="{{mix('js/receiptAdd.js')}}"></script>
 					...
 					<form id="warehouseForm" action="javascript:;">
 						<div class="modal-body">
 							<div class="form-group">
 								...
 								<input type="text" required id="code" name="code" class="form-control" placeholder="Nhập mã hóa đơn">
